      ...
      <div className="bg-primary-color bg-primary-bg text-primary-text dark:bg-darkMode-bg dark:text-darkMode-text">
        ...
        <div className="h-auto w-[90%] md:w-[50%] rounded-lg mx-auto bg-secondary-bg dark:bg-secondary-darkMode-bg shadow">
          ...
          <div className="article-section p-2 md:p-8">
            ...
            <div className="content-section leading-loose md:text-lg py-4 ">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit.
              Repudiandae modi dolores necessitatibus, deserunt nobis maiores
              aliquam? Natus sit aliquid a quidem molestias? Rem labore dolores
              ...
              accusamus exercitationem pariatur, provident tempore illo.
              Adipisci numquam perferendis laborum eum, accusantium, a hic sint
              provident, placeat similique nobis! Autem numquam nostrum hic eius
              neque reiciendis, magni ex! Vero, eum commodi. Earum facere in
              ipsam labore ex quod culpa, ducimus eum dolorum, cum dignissimos!
              Sequi deleniti eum doloremque consequatur, fugit minus doloribus
              porro ratione aut repellat autem eos, omnis architecto neque nulla
              quia quisquam rerum ut eligendi recusandae. Dolorem et, ipsam qui,
              rerum consequuntur aperiam dolorum deleniti ullam earum
              praesentium labore animi eos veniam eius ex possimus facere natus
              itaque quisquam architecto modi maxime ducimus illo. Eius adipisci
              expedita reprehenderit repudiandae exercitationem atque modi
              explicabo quas inventore error? Quidem voluptatibus praesentium
              eius distinctio atque provident repellat aliquam earum cumque
              aspernatur pariatur obcaecati veniam eaque error animi neque culpa
              a ipsa, sit alias nesciunt. Tempore, ex? Praesentium veritatis non
              ratione maxime, soluta saepe necessitatibus eius corporis quasi
              iusto optio.
            </div>
            <hr />
            ...
            <div className="comment-section">
              <div className="flex gap-4">
                <img
                  ...
                  className="h-10 w-10 md:h-12 md:w-12 rounded-full object-cover"
                />
                <div className="bg-inherit w-full my-4 rounded-lg p-4 border">
